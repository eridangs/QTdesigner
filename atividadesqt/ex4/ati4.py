...
# Form implementation generated from reading ui file 'ati4.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEditNum.setGeometry(QtCore.QRect(250, 150, 141, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.lineEditNum.setFont(font)
        self.lineEditNum.setObjectName("lineEditNum")
        self.labelResult = QtWidgets.QLabel(self.centralwidget)
        self.labelResult.setGeometry(QtCore.QRect(140, 220, 401, 211))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_titulo.setGeometry(QtCore.QRect(260, 20, 161, 51))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_num.setGeometry(QtCore.QRect(80, 150, 151, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.pushButtonEnviar.setGeometry(QtCore.QRect(430, 150, 93, 28))
        font = QtGui.QFont()
        font.setPointSize(10)
